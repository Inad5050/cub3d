...
/*   Updated: 2025/01/23 16:01:42 by dangonz3         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	mlx_put_image_to_window(c->mlx, c->win_mlx_2D, c_img->img_ptr, x * CELL_WIDHT, y * CELL_HEIGHT);
}

void	player_print(double y, double x, t_img *c_player_img, t_cub *c) //imprime al jugador en pantalla
{	
	mlx_put_image_to_window(c->mlx, c->win_mlx_2D, c_player_img->img_ptr, (int)x, (int)y);
}
