...
/*   Updated: 2024/12/30 20:36:17 by dangonz3         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* int	map_limits(t_cub *c, int move_x, int move_y)
{
	...
	c->p_y = c->p_y + ((double)move_y * 8 / 64);
	c->p_x = c->p_x + (double)(move_x * STEP_SIZE / IMG_WIDHT); //HAY QUE CASTEAR EL MOVE_Y A DOUBLE

	printf("(double)((move_y * 8 / 64) = %f\n", ((double)move_y * 8 / 64));
	// printf("(double)(move_x * STEP_SIZE / IMG_WIDHT) = %f\n", (double)(move_x * STEP_SIZE / IMG_WIDHT));
