...
/*   Updated: 2025/01/23 15:41:48 by dangonz3         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	mlx_hook(c->win_mlx_2D, ON_DESTROY, 1L << 17, c_close, c); //cierra la ventana 2D si pulsamos la cruz
	mlx_hook(c->win_mlx_3D, ON_DESTROY, 1L << 17, c_close, c); //cierra la ventana 3D si pulsamos la cruz
